  ...
  async function handleAiGenerate() {
    ...
    try {
      const res = await fetch('/api/ai/news-gen', {
        ...
        body: JSON.stringify({ topic: aiTopic, category: form.category || 'news' }),
      });
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-gradient-to-br from-[#1e40af]/5 to-purple-50 rounded-xl border-2 border-[#1e40af]/20 p-6">
          ...
          <p className="text-xs text-gray-500 mb-3 leading-relaxed">
            ...
            AIが<strong>メインタイトル・SEOタイトル・メタディスクリプション</strong>を自動生成します（既存の内容は上書きされます）。
          </p>
            ...
            <textarea
              ...
              placeholder={
                form.category === 'result'
                  ...
                  : form.category === 'event'
                  ? '例: 育成就労制度に関する無料セミナーを2027年1月に開催。受入企業向け、オンライン参加可能。'
