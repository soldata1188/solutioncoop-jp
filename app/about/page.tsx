  ...
  return (
    <>
      ...
      <main className="pt-16 md:pt-20 bg-gray-50 min-h-screen">
        {/* Page Hero */}
        <section className="py-14 md:py-20 relative overflow-hidden text-white bg-blue-600">
          <div className="absolute inset-0 pointer-events-none opacity-20">
            ...
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-orange-500/40 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl" />
          </div>
        ...
        <section id="overview" className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-white border border-blue-100 rounded-lg overflow-hidden shadow-sm">
              ...
              <table className="w-full text-sm">
                <tbody className="divide-y divide-blue-50">
                  {[
                    ...
                    <tr key={String(label)} className="hover:bg-blue-50/50 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
              {[
                ...
                <a key={d.label} href={d.file} target="_blank" rel="noopener noreferrer"
                  className="group flex items-center gap-4 p-5 bg-white border border-blue-200 rounded-xl hover:border-blue-500 hover:shadow-md transition-all">
                  <span className="text-3xl bg-blue-50 group-hover:bg-blue-100 text-blue-600 p-3 rounded-xl transition-colors">{d.icon}</span>
                  <div className="flex-1">
                    <span className="font-black text-sm block mb-1 text-slate-800 group-hover:text-blue-700 transition-colors">{d.label}</span>
                    <span className="text-[10px] text-slate-500">{d.desc}</span>
                  </div>
                  <span className="ml-auto text-xl text-blue-300 group-hover:text-blue-600 transition-colors">→</span>
                </a>
              ))}
            </div>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="border border-gray-200 rounded overflow-hidden shadow-sm">
              <div className="px-6 py-4 bg-blue-600 flex items-center justify-between flex-wrap gap-2">
                <div className="flex items-center gap-2">
                  <span className="text-orange-400 font-black">⇄</span>
                  <span className="text-white font-bold text-sm">制度比較ガイド</span>
                </div>
                <span className="text-blue-200 text-[10px] font-bold uppercase tracking-widest bg-blue-800/40 px-2 py-0.5 rounded-full">法務・公開情報</span>
              </div>
        ...
        <section className="py-20 bg-blue-50 border-t border-blue-100">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl font-black text-blue-900 mb-8">お気軽にご相談ください</h2>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <TrackedLink href="/contact" eventAction="cta_click" eventLabel="about_bottom_contact"
                className="w-full sm:w-80 bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-lg shadow-lg hover:-translate-y-1 transition-all duration-300">
                ✉️ 無料相談フォームへ
              </TrackedLink>
              <a href="tel:0722248067"
                className="w-full sm:w-80 bg-white border-2 border-blue-600 text-blue-600 font-bold py-3.5 rounded-lg hover:bg-blue-600 hover:text-white transition-all shadow-sm">
                📞 072-224-8067
              </a>
            </div>
          </div>
