    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="bg-white p-6 md:p-8 rounded shadow-sm border border-gray-100 mb-8 border-t-4 border-t-[#f97316]">
        ...
        <form onSubmit={handleUpload} className="flex flex-col md:flex-row gap-5 items-end">
          ...
          <div className="flex-1 w-full relative">
            <label className="block text-[11px] font-black text-gray-500 uppercase tracking-widest mb-2">ファイル (PDF/Excel 等) <span className="text-red-500">*</span></label>
            <input type="file" id="fileInput" onChange={e => setFile(e.target.files?.[0] || null)} required accept=".pdf,.doc,.docx,.xls,.xlsx"
