      ...
      <div className="container mx-auto px-4 h-16 md:h-20 flex justify-between items-center gap-2">
        ...
        <nav className="hidden lg:flex items-center space-x-1 text-sm font-medium text-gray-600" aria-label="メインナビ">
          ...
          <Link href="/about#disclosure"
            className="text-accent font-bold border-2 border-accent px-3 py-1.5 rounded-lg hover:bg-accent hover:text-white transition ml-2">
            情報公開
          </Link>
        </nav>
        ...
        <div className="lg:hidden bg-white border-t border-gray-100">
          <nav className="container mx-auto px-4 py-4 space-y-1">
            ...
            <Link href="/about#disclosure" onClick={() => setMenuOpen(false)}
              className="block text-accent font-bold p-4 hover:bg-orange-50 rounded-lg">
              情報公開
            </Link>
            <div className="pt-3">
              <a href="tel:0722248067"
                className="flex items-center justify-center w-full text-navy font-bold py-4 border-2 border-navy rounded-lg hover:bg-blue-50 transition shadow-sm">
                📞 072-224-8067
              </a>
            </div>
          </nav>
