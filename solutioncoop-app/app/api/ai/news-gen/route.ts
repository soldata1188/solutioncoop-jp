...
以下のキーを持つ有効な単一のJSONオブジェクトのみを返してください：
{
  ...
  "content": "(最大1200文字) Markdown形式の本文。H2/H3、箇条書き、ボールドを使用。署名で終わる。",
